...
public class Tainted_crystalOreBlock extends Block {
	public Tainted_crystalOreBlock() {
	...
	public List<ItemStack> getDrops(BlockState state, LootParams.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(GatesModItems.TAINTED_CRYSTAL_DUST.get(), 3));
	}
}
