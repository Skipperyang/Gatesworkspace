...
import net.mcreator.gates.world.teleporter.TheBrinkTeleporter;
import net.mcreator.gates.world.teleporter.TheBrinkPortalShape;

import java.util.Optional;

public class TheBrinkPortalBlock extends NetherPortalBlock {
	public TheBrinkPortalBlock() {
	...
	public static void portalSpawn(Level world, BlockPos pos) {
		Optional<TheBrinkPortalShape> optional = TheBrinkPortalShape.findEmptyPortalShape(world, pos, Direction.Axis.X);
	...
	public BlockState updateShape(BlockState p_54928_, Direction p_54929_, BlockState p_54930_, LevelAccessor p_54931_, BlockPos p_54932_, BlockPos p_54933_) {
		...
		return !flag && !p_54930_.is(this) && !(new TheBrinkPortalShape(p_54931_, p_54932_, direction$axis1)).isComplete() ? Blocks.AIR.defaultBlockState() : super.updateShape(p_54928_, p_54929_, p_54930_, p_54931_, p_54932_, p_54933_);
	}
	...
	public void entityInside(BlockState state, Level world, BlockPos pos, Entity entity) {
		if (entity.canChangeDimensions() && !entity.level().isClientSide() && true) {
			...
			} else if (entity.level().dimension() != ResourceKey.create(Registries.DIMENSION, new ResourceLocation("gates:the_brink"))) {
				entity.setPortalCooldown();
				teleportToDimension(entity, pos, ResourceKey.create(Registries.DIMENSION, new ResourceLocation("gates:the_brink")));
			} else {
				entity.setPortalCooldown();
	...
	private void teleportToDimension(Entity entity, BlockPos pos, ResourceKey<Level> destinationType) {
		entity.changeDimension(entity.getServer().getLevel(destinationType), new TheBrinkTeleporter(entity.getServer().getLevel(destinationType), pos));
	}
}
